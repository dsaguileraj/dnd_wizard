  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        />
        <Route
          path='/damage_type/create'
          element={<DamageTypePostForm />}
        />
        {/* RULES - Feature */}
        <Route
          path='/feature'
        ...
        />
        <Route
          path='/magic_school/create'
          element={<MagicSchoolPostForm />}
        />
        {/* RULES - Skill */}
        <Route
          path='/skill'
