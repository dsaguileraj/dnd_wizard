...
export const AdventureGearPostForm = () => {
  ...
  return (
    <Form errorMessage={errorMessage} handleSubmit={handleSubmit} header="Create Adventure Gear">
      ...
      <InputSelect field={coin} handleChange={setCoin} label="Coin" options={COINS} />
      <InputNumber field={weight} handleChange={setWeight} label="Weight" />
      <InputSelect field={weightMeasure} handleChange={setWeightMeasure} label="Weight Measure" options={MEASURE_MASS} />
...
export const ArmorPostForm = () => {
  ...
  return (
    <Form errorMessage={errorMessage} handleSubmit={handleSubmit} header="Create Armor">
      <InputText field={name} handleChange={setName} label="Name" />
      <InputSelect field={category} handleChange={setCategory} label="Category" options={categoryOptions} />
      <InputNumber field={cost} handleChange={setCost} label="Cost" />
      <InputSelect field={coin} handleChange={setCoin} label="Coin" options={COINS} />
      <InputNumber field={weight} handleChange={setWeight} label="Weight" />
      <InputSelect field={weightMeasure} handleChange={setWeightMeasure} label="Weight Measure" options={MEASURE_MASS} />
      <InputNumber field={armorClass} handleChange={setArmorClass} label="Armor Class (AC)" />
      <InputCheck handleChange={setDexBonus} label="DEX Bonus" />
      <InputNumber field={maxDexBonus} handleChange={setMaxDexBonus} label="Max DEX Bonus" />
      <InputNumber field={minStr} handleChange={setMinStr} label="Min. STR" />
...
export const SpellPostForm = () => {
  ...
  return (
    <Form errorMessage={errorMessage} handleSubmit={handleSubmit} header="Create Spell">
      <InputText field={name} handleChange={setName} label="Name" />
      <InputTextArea field={description} handleChange={setDescription} label="Description" />
      <InputSelect field={entityClass} handleChange={setEntityClass} label="Classes" multiple={true} options={entityClassOptions} />
      <InputSelect field={magicSchool} handleChange={setMagicSchool} label="Magic School" options={magicSchoolOptions} />
      <InputSelect field={damageType} handleChange={setDamageType} label="Damage Type" options={damageTypeOptions} />
      <InputNumber field={level} handleChange={setLevel} label="Level" max={9} />
      <InputNumber field={spellRange} handleChange={setSpellRange} label="Range" />
      <h2>Components</h2>
      <InputCheck field={verbal} handleChange={setVerbal} label="Verbal" />
      <InputCheck field={somatic} handleChange={setSomatic} label="Somatic" />
      <InputCheck field={material} handleChange={setMaterial} label="Material" />
      {material && <InputTextArea field={materials} handleChange={setMaterials} label="Materials Description" />}
      <h2>Casting</h2>
      <InputCheck field={isRitual} handleChange={setIsRitual} label="Ritual" />
      <InputNumber field={castingTime} handleChange={setCastingTime} label="Time" />
      <InputNumber field={castingMeasure} handleChange={setCastingMeasure} label="Measure" />
      <h2>Duration</h2>
      <InputCheck field={needConcentration} handleChange={setNeedConcentration} label="Need Concentration?" />
      <InputNumber field={duration} handleChange={setDuration} label="Time" />
      <InputNumber field={durationMeasure} handleChange={setDurationMeasure} label="Measure" />
    </Form>
  );
};
...
export const TrinketPostForm = () => {
  ...
  return (
    <Form errorMessage={errorMessage} handleSubmit={handleSubmit} header="Create Trinket">
      <InputTextArea field={name} handleChange={setName} label="Name" />
    </Form>
  );
};
...
export const WeaponPostForm = () => {
  ...
  const [weight, setWeight] = useState(0);
  const [weightMeasure, setWeightMeasure] = useState("lb");
  const [hitDices, setHitDice] = useState(0);
  ...
  return (
    <Form errorMessage={errorMessage} handleSubmit={handleSubmit} header="Create Weapon">
      <InputText field={name} handleChange={setName} label="Name" />
      <InputSelect field={category} handleChange={setCategory} label="Category" options={categoryOptions} />
      <InputNumber field={cost} handleChange={setCost} label="Cost" />
      <InputSelect field={coin} handleChange={setCoin} label="Coin" options={COINS} />
      <InputNumber field={weight} handleChange={setWeight} label="Weight" />
      <InputSelect field={weightMeasure} handleChange={setWeightMeasure} label="Weight Measure" options={MEASURE_MASS} />
      <InputNumber field={hitDices} handleChange={setHitDice} label="Hit Dices" />
      <InputNumber field={diceSides} handleChange={setDiceSides} label="Dice Sides" />
      <InputNumber field={modifier} handleChange={setModifier} label="Modifier" />
      <InputSelect field={damageType} handleChange={setDamageType} label="Damage Type" options={damageTypeOptions} />
      <InputSelect field={property} handleChange={setProperty} label="Properties" multiple={true} options={propertyOptions} />
      <InputCheck field={rangedWeapon} handleChange={setRangedWeapon} label="Ranged Weapon?" />
      {rangedWeapon && <InputNumber field={normalRange} handleChange={setNormalRange} label="Normal Range" />}
      {rangedWeapon && <InputNumber field={maxRange} handleChange={setMaxRange} label="Max Range" />}
    </Form>
  );
};
